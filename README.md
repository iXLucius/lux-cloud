...
- 按`顺序`运行main类：CenterBootstrap（lux-center）、ConfigServerBootstrap（lux-config）、AdminBootstrap（lux-admin）、AuthBootstrap（lux-auth-server）、GateBootstrap（lux-gate）
