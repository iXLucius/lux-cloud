package com.tencloud.lux.security.common.context;

import com.tencloud.lux.security.common.constant.CommonConstants;
import com.tencloud.lux.security.common.util.StringHelper;
...
public class BaseContextHandler {
    ...
    public static void set(String key, Object value) {
        ...
        log.info("==============Thread-ID = {},key = {} , value = {}",Thread.currentThread().getName(),key,value);
